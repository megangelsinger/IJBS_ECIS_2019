...
setEPS()
postscript("figure1.eps", width = 10, height = 4.5, family = "Times")
...
# Put together and save #
setEPS()
postscript("figure3.eps", width = 12, height = 4.5, family = "Times")
...
# Put together and save #
setEPS()
postscript("figure4.eps", width = 12, height = 4.5, family = "Times")
...
# Put together and save #
setEPS()
postscript("supplementalfigure1.eps", width = 12, height = 4.5, family = "Times")
...
# Put together and save #
setEPS()
postscript("supplementalfigure3.eps", width = 6, height = 9, family = "Times")
...
contour(x = fig4_s_a_parms$nd.x, y = fig4_s_a_parms$nd.y, z = matrix(fig4_s_a_parms$prd, nrow = 300, ncol = 300), 
        levels = c(1:15), add = TRUE, drawlabels = FALSE)
legend(x = max(fig4_s_data[, 1]) + 100, y = max(fig4_s_data[, 2]) + 300, legend = unique(results_gel$cells),
...
# Put together and save #
setEPS()
postscript("supplementalfigure4.eps", width = 6, height = 9, family = "Times")
...
# Put together and save #
setEPS()
postscript("supplementalfigure5.eps", width = 12, height = 4.5, family = "Times")
...
contour(x = fig6_s_a_parms$nd.x, y = fig6_s_a_parms$nd.y, z = matrix(fig6_s_a_parms$prd, nrow = 300, ncol = 300), 
        levels = c(1:15), add = TRUE, drawlabels = FALSE)
legend(x = max(fig6_s_data[, 1]) + 300, y = max(fig6_s_data[, 2]) + 200, legend = unique(results_bsa$cells),
...
# Put together and save #
setEPS()
postscript("supplementalfigure6.eps", width = 6, height = 9, family = "Times")
